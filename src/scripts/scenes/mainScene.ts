...
import { gameStateController, selectedObjectController, mapController, guiController, heldObjectController, gameDeltaController } from "../game";
...
export default class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    new MapView(this, gameStateController, gameDeltaController, soilColourConverter, heldObjectController, mapController);
